...
public class AspirationFirstPrefAdapter extends RecyclerView.Adapter<AspirationFirstPrefAdapter.MyViewHolder> {
    private static final String TAG = "AspirationFirstPrefAdap";
    ...
    public AspirationFirstPrefAdapter(Context context, List<FirstPreferenceDataModel> dataList, SelectItem selectItem, String type) {
...
//            }
    ...
    {
      String mSelectedSubject = SharedPrefsHelper.getInstance().get(SELECTED_SUBJECT_ASPIRATION, null);

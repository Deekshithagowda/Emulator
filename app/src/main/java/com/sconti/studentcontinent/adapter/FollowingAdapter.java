...
public class FollowingAdapter extends RecyclerView.Adapter<FollowingAdapter.MyViewHolder> {
    ...
    private List<FollowModel> mFollowersModelList , mFollowersModelListFull, myFollowingList;
    ...
    public FollowingAdapter(Context context, List<FollowModel> mFollowersModelList, List<FollowModel> myFollowingList, SelectItem selectItem, boolean isOtherProfile) {
        this.context = context;
        this.mFollowersModelList = mFollowersModelList;
        mFollowersModelListFull = new ArrayList<>(mFollowersModelList);
    ...
    {
                FollowModel dataModel = myFollowingList.get(position);
    ...
    private Filter mFollowersModelListFilter = new Filter() {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            if (constraint == null || constraint.length() == 0 ){
                filterList.addAll(mFollowersModelListFull);
            }else {
                String filterPattern = constraint.toString().toLowerCase().trim();

                for(FollowModel item : mFollowersModelListFull){

...
public class GameFirstPrefAdapter extends RecyclerView.Adapter<GameFirstPrefAdapter.MyViewHolder> {
    private static final String TAG = "GameFirstPrefAdapter";
    ...
    public GameFirstPrefAdapter(Context context, List<FirstPreferenceDataModel> dataList, SelectItem selectItem, String type) {
...
//            });
    ...
    {
      String mSelectedSubject = SharedPrefsHelper.getInstance().get(SELECTED_SUBJECT_GAME, null);

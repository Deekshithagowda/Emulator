...
public class FollowingFragment extends Fragment {
    ...
    private List<FollowModel> mFollowersModelList, myFollowingList;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mView =  inflater.inflate(R.layout.fragment_followinglist, container, false);
        ...
        listCall.enqueue(new Callback<NewAPIResponseModel>() {
            ...
            public void onResponse(Call<NewAPIResponseModel> call, Response<NewAPIResponseModel> response) {
                ...
                if (mFollowersModelList != null && mFollowersModelList.size()>0) {
                    ...
                    followingAdapter = new FollowingAdapter(getContext(), mFollowersModelList, myFollowingList, selectItem, ISFROM_OTHER_PROF);

...
import com.sconti.studentcontinent.activity.knowledge.fragments.PlaceholderFragment;
 ...
 */
public class KnowledgeSectionsPagerAdapter extends FragmentPagerAdapter {
    ...
    public KnowledgeSectionsPagerAdapter(Context context, FragmentManager fm) {
        super(fm);
        mContext = context;
    }

...
public class OutDoorTagsPrefAdapter extends RecyclerView.Adapter<OutDoorTagsPrefAdapter.MyViewHolder> {
    ...
    public OutDoorTagsPrefAdapter(Context context, List<OutDoorPostModel> dataList, SelectItem selectItem) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        try {
            ...
            if(dataModel.getMediaURL()!=null && !dataModel.getMediaURL().isEmpty())
            {
                Glide.with(context).load(dataModel.getMediaURL()).into(holder.mImageViewContent);
                holder.mImageViewContent.setVisibility(View.VISIBLE);
            }
            else
            {
                holder.mImageViewContent.setVisibility(View.GONE);
            }
            ...
            if(dataModel.getPrfurl()!=null){
                Glide.with(context).load(dataModel.getPrfurl()).into(holder.avatar);
            }

package com.sconti.studentcontinent.activity.aspiration.fragments;
...
import com.sconti.studentcontinent.adapter.AspirationFirstPrefAdapter;
...
public class FirstPreferenceFragment extends BaseFragment implements AspirationFirstPrefAdapter.SelectItem{
    ...
    private AspirationFirstPrefAdapter firstPrefAdapter;
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                if (ContinentTools.hasInternetConnection(getContext())) {
                    ...
                    getFollowersList();
                    getLikeListByUserID();
                    getCategory(mSelectedSubject, 1, 3, 0);
                }
            }
        });
    ...
    private RecyclerView mLatestTrendsRecyclerView; // TODO : udaua add
    ...
    private void getShareListByUserID()
    {
        //commit
        String userID = SharedPrefsHelper.getInstance().get(USER_ID);
        Call<NewAPIResponseModel> call = apiInterface.GetShareListByUserID(userID, 3);
        call.enqueue(new Callback<NewAPIResponseModel>() {
            @Override
            public void onResponse(Call<NewAPIResponseModel> call, Response<NewAPIResponseModel> response) {
    ...
    private void getCommentListByUserID()
    {
        ...
        Call<NewAPIResponseModel> call = apiInterface.GetCommentListByUserID(userID, 3);
        call.enqueue(new Callback<NewAPIResponseModel>() {
            @Override
            public void onResponse(Call<NewAPIResponseModel> call, Response<NewAPIResponseModel> response) {
            ...
            public void onResponse(Call<NewAPIResponseModel> call, Response<NewAPIResponseModel> response) {
                ...
                if(response.body().isStatus()){
                    ...
                    if (TagDataModelList != null) {
                        ...
                        PostAdapter = new OutDoorTagsPrefAdapter(mActivity, mFollowersList , likeDatalist ,commentDataList,shareDataList, TagDataModelList, selectItemInterface2, mediaController, 3);
                        mRecyclerView.setLayoutManager(new LinearLayoutManager(mActivity, LinearLayoutManager.VERTICAL, false));
                        mRecyclerView.setAdapter(PostAdapter);
                        PostAdapter.notifyDataSetChanged();
                        //Toast.makeText(getContext(), "done" +TagDataModelList.size(), Toast.LENGTH_SHORT).show();
//                        mRelativeLayout.setVisibility(View.GONE);
    ...
    public void onStart() {
        ...
        SharedPreferences sp = mActivity.getSharedPreferences(ASPIRATION_FIRST_POST_1, MODE_PRIVATE);
        boolean cb1 = sp.getBoolean("myBool", false);

        if(cb1)
        {
            getCategory(mSelectedSubject , 1 , 3 , offset);
        }
        SharedPreferences.Editor editor123 = mActivity.getSharedPreferences(ASPIRATION_FIRST_POST_1, MODE_PRIVATE).edit();
        editor123.putBoolean("myBool",false);
        editor123.apply();


        SharedPreferences prefs = mActivity.getSharedPreferences(DATA_OF_COMMENT_AND_SLNO3, MODE_PRIVATE);
        ...
        if(numComments>0 && id>0)
        {
            ...
            SharedPreferences.Editor editor = mActivity.getSharedPreferences(DATA_OF_COMMENT_AND_SLNO3, MODE_PRIVATE).edit();
            ...
            SharedPreferences prefs1 = mActivity.getSharedPreferences(DATA_OF_COMMENT_AND_SLNO3, MODE_PRIVATE);
...
//            alertDialogMoreOptions.show();
    ...
    private AspirationFirstPrefAdapter.SelectItem selectItemInterface = new AspirationFirstPrefAdapter.SelectItem() {
        @Override
        public void selectedPosition(int position) {
            Intent intent = new Intent(getContext(), DetailsActivity.class);
            ...
            public void onScrollStateChanged(@NonNull RecyclerView recyclerView, int newState) {
                ...
                if (newState == RecyclerView.SCROLL_STATE_IDLE) {
                    ...
                    if (!recyclerView.canScrollVertically(1)) {
                        ...
                        {
                            offset=offset+20;
                            getCategoryPage(mSelectedSubject, 1, 3 ,offset);
    ...
    private void initViews() {
        ...
        mLatestTrendsRecyclerView = mRootView.findViewById(R.id.recycler_latest);  // TODO : udaya add
    ...
    private void submitData() {
        ...
        databaseReference = ContinentApplication.getFireBaseRef().child(ASPIRATION_FIRST).child(mSelectedSubject);
    ...
    private void uploadImage(Uri filePath) {
        ...
        if(filePath != null)
        {
            ...
            final StorageReference ref = storageReference.child("images").child(ASPIRATION_FIRST).child(mSelectedSubject).child(UUID.randomUUID().toString());

...
public class MediaObject implements Parcelable {
    ...
    public MediaObject(String college, String prfurl, String category_id, String postId, long sl_no, String title, String description, String postedById, String postedByName, int mediaType, String mediaURL, String category, long created_on, long updated_on, long numLikes, long numShares, long numComments) {
        this.title = title;
    ...
    public static Creator<MediaObject> getCREATOR() {
        return CREATOR;
    }
